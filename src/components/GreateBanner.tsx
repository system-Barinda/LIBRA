...
export const GreateBanner: React.FC = () => {
  ...
  return (
    <div
      ref={heroRef}
      className="relative overflow-hidden bg-gradient-to-r from-orange-800 via-amber-500 to-orange-600 p-6 md:p-8 text-white shadow flex flex-col lg:flex-row items-center justify-between gap-8"
    >
      {/* Left Content Area */}
