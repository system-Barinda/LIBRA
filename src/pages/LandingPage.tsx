      ...
      <aside className="hidden lg:flex flex-col w-64 bg-white border-r border-gray-200 min-h-screen sticky top-0 justify-between p-5 z-20">
        <div>
          ...
          <div className="flex items-center gap-2.5 mb-8 px-2">
            <div className="w-9 h-9 bg-orange-500 rounded-xl flex items-center justify-center text-white font-bold shadow-md shadow-orange-200">
              <BookOpen className="w-5 h-5" />
            </div>
            <span className="font-extrabold text-xl tracking-wider text-gray-900">
              LIBRA
            </span>
          </div>
          ...
          <nav className="space-y-1">
            {[
              ...
              { name: "Library Activity", icon: Activity },
              { name: "Books", icon: BookOpen },
              { name: "Management", icon: Users, hasSub: true },
              ...
              >
                ...
                {item.hasSub && (
                  <ChevronDown
                    className={`w-4 h-4 ${activeTab === item.name ? "text-white" : "text-gray-400"}`}
                  />
                )}
              </button>
            ))}
